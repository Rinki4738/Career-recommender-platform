  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        <input type="text" placeholder='Enter a skill (e.g. Java, Project Manager)' className='flex-1 px-3 py-2 text-sm' onChange={(e)=>setNewSkill(e.target.value)}
        value={newSkill}
    ...
    <div className='bg-blue-50 p-3 rounded-lg'>
      <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12 relevant skills. Include both tehnical skills (programming languages, tools) and soft skills (leadership, communication)</p>
    </div>
