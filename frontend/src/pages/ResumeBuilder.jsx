import { ArrowLeftIcon, Briefcase, ChevronLast, ChevronLeft, ChevronRight, FileText, FolderIcon, GraduationCap, Sparkles, User } from 'lucide-react'
...
const ResumeBuilder = () => {
  ...
  const loadExistingResume = async () =>{
     ...
     if(resume){
      ...
      document.title = resume.title   //add resume title in document
     }
  }
